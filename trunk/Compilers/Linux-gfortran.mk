...
ifdef USE_NETCDF4
        NF_CONFIG ?= nc-config
    NETCDF_INCDIR ?= /opt/ohpc/pub/libs/gnu8/openmpi3/netcdf-fortran/4.5.2/include
#    NETCDF_INCDIR ?= $(shell $(NF_CONFIG) --prefix)/include
            LIBS += $(shell $(NF_CONFIG) --flibs)
           INCDIR += $(NETCDF_INCDIR) $(INCDIR)
else
    NETCDF_INCDIR ?= /mnt/home/cyue/nc/nc/include
    NETCDF_LIBDIR ?= /mnt/home/cyue/nc/nc/f90
      NETCDF_LIBS ?= -lnetcdf
